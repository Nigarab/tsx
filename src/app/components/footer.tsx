...
export const Header = ()=>{
    ...
    <p className="icons-p">Lorem ipsum dolor sit amet, consectetur advising elite.
      Duis sit vehicula dui sit amet ligula cursus.</p>
      <div className="privacy-div">
      <a href="#" className="privacy">Privacy</a>
      <a href="#" className="privacy">Account</a>
      <a href="#" className="privacy">Unsubscribe</a>
    </div>
